...
<div class="row">
    ...
    <div class="col-lg-2">Npn-Call Period</div>
</div>
...
<div class="clearfix">
  <button onClick="window.location.href='summary_save.php';" class="btn btn-outline-success float-left" type="button">Save</button>   
</div>
